...
|------|-------------|------|---------|:--------:|
| <a name="input_balancer_id"></a> [balancer\_id](#input\_balancer\_id) | ID of the load balancer. | `any` | n/a | yes |
| <a name="input_namespace"></a> [namespace](#input\_namespace) | The ingress-nginx namespace. | `string` | `"ingress-nginx"` | no |
